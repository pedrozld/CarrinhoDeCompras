...
//let api = 'https://618e6a1850e24d0017ce1294.mockapi.io/api/v1/products'

let modelsJson = //new XMLHttpRequest();
...
[
    ...
    {"id":8, name:'Pizza calabresa', img:'img/pizza.png', price:[100.00, 150.00, 200.00], sizes:['8pedaços', '4Pedaços', '1pedaço'], description:'pizza estranh pra comer com colher'}
